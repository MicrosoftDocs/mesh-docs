...
**Boombox** 
    ...
    This is similar in operation to the Radio, with a slightly different music style. The script for playing the sound (*PlayButton_Script*) is attached to the *toybox_play_button_01_varient* object. The script has a subgraph (*BoomboxState*) that contains the nodes for the audio.
