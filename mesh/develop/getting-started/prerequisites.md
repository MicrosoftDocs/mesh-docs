...
Your installation should include modules for Android and Windows. Make sure to include the module ``Windows Build Support (IL2CPP)`` as this is required. When you create a new project, we recommend using the URP 3D Core template.
