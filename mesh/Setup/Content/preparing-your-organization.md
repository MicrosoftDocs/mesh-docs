...
- If the organization chooses to have managed Quest devices: 

- If the organization wants to make an exception for Quest: Create a Conditional Access policy that is acceptable to the company's risk profile while still permitting access to Quest devices via 

Both routes will enable the use of Mesh. However, it's recommended that organizations manage their Quest devices to ensure security and compliance. 
